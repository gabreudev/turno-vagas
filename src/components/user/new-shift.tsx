...
import { createShiftRequestSchema } from '@/common/validations/shift/create-shift/create-shift-request.dto';
...
export function NewShift({
  ...
  async function onSubmit(newShiftData: CreateShiftRequestDto): Promise<void> {
