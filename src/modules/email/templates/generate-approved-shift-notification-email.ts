export function genererateApprovedShiftNotificationEmail(
  name: string,
  email: string,
  weekDay: string,
  startAt: string,
  ...
  return `<div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        <h2 style="color: #333333;">Turno Aprovado</h2>
        
        <p style="color: #666666;">Olá ${name}</p>
        
        <p style="color: #666666;">Informamos que o seguinte turno acaba de ser aprovado por um de nossos administradores.</p>
